 ...
 * @author trabe
 */
public class ListTopic extends Form {
    
    public ListTopic(Form previous) {
        TopicService sp = new TopicService();
        ArrayList<Topic> topics = sp.affichageCategory();
            ...
            pdf.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent m) {
                    try {
                        ...
                        String outputPath = "file:///C:/xampp/pdfmayssa/topic" + topic.getId() + ".pdf";
...
document.add(new Paragraph("Fiche des Topic"));
document.add(new Paragraph("Titre :" + topic.getDescription()));
document.add(new Paragraph("Description :" + topic.getDate()));
...
Log.p("PDF file successfully created!");
    ...
    c.add(BorderLayout.EAST, btnModifier);
    c.add(BorderLayout.WEST,pdf);
 ...
 Button sortCommand = new Button("Tri Par Titre", FontImage.createMaterial(FontImage.MATERIAL_SORT, getUnselectedStyle()));
        Button sortDate = new Button("Tri Par Date", FontImage.createMaterial(FontImage.MATERIAL_SORT, getUnselectedStyle()));
        sortCommand.addActionListener(e -> new TrierParDescription(this).show());
        add(sortCommand);
        sortDate.addActionListener(e -> new TrierParDate(this).show());
        add(sortDate);
